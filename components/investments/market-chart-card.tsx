...
const T = {
  title: "نمودار بازار",
  desc: "تاریخچه بازار از منابع فعال TSETMC، BrsApi و Tindex دریافت می‌شود و Snapshotهای واقعی دستگاه برای زمان اختلال حفظ می‌شوند.",
  remote: "تاریخچه واقعی بازار",
  local: "Fallback از Snapshotهای واقعی این دستگاه",
  emptyTitle: "داده تاریخی کافی نداریم",
  emptyDesc: "برای نمادهای پشتیبانی‌شده، تاریخچه آنلاین از منابع بازار دریافت می‌شود. اگر تاریخچه تازه در دسترس نباشد، Snapshotهای واقعی دستگاه نمایش داده می‌شوند.",
  current: "قیمت فعلی",
