...
export function PortfolioTables({ positions, allocationRows, transactions, assets, settings, onTransaction, onEditAsset, onArchiveAsset, onEditTransaction, onDeleteTransaction }: {
