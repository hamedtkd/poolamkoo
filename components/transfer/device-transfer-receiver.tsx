...
function Preview({ preview, onImport }: { preview: NonNullable<Controller["preview"]>; onImport: () => void }) {
  const rows = [["پول‌های ورودی", preview.incomes], ["صندوق‌ها", preview.funds], ["گردش صندوق", preview.fundMovements], ["دارایی‌ها", preview.assets], ["تراکنش‌ها", preview.transactions], ["وام‌ها", preview.loans], ["اقساط وام", preview.loanPayments], ["هشدار وام", preview.loanRiskAlerts], ["کارت‌های برنامه", preview.planItems], ["دیده‌بان", preview.watchlist], ["هشدارها", preview.alerts]] as const;
