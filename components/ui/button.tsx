...
export function buttonStyles({ variant = "default", size = "default", className }: {
  ...
  return cn(
    "inline-flex shrink-0 items-center justify-center gap-2 rounded-lg type-button transition-[transform,background-color,color,border-color,filter,box-shadow] duration-150 active:scale-[.985] motion-reduce:active:scale-100 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
    variants[variant],
    sizes[size],
    className,
  );
