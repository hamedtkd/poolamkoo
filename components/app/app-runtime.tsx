...
import type { useLoanReminders } from "@/hooks/use-loan-reminders";
import type { useLoanRiskMonitoring } from "@/hooks/use-loan-risk";
...
type LoanReminders = ReturnType<typeof useLoanReminders>;
type LoanRisk = ReturnType<typeof useLoanRiskMonitoring>;
