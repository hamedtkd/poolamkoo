...
export function FundsSection({ funds, fundMovements, planItems, settings }: {
  ...
  return <div className="space-y-5">
    ...
    {selectedMovementFund && <FundMovementDialog key={`${selectedMovementFund.id ?? "fund"}-${editingMovement?.id ?? "new"}`} fund={selectedMovementFund} movement={editingMovement} onClose={() => { setMoveFund(null); setEditingMovement(null); }} settings={settings} />}
