...
export function NetworkStatusBanner() {
  ...
  return (
    ...
    >
      ...
      <span><strong className="font-[650]">آفلاین هستی.</strong> ثبت و ویرایش پول، صندوق و سرمایه‌گذاری همچنان کار می‌کند. موجودی‌های محلی محفوظ‌اند؛ فقط قیمت بازار و سرویس‌های آنلاین تا برگشت اتصال به‌روز نمی‌شوند.</span>
    </div>
  );
}
