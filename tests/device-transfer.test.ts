...
test("transfer payload preview validates required Poolamkoo data", () => {
  ...
  assert.deepEqual(preview, { incomes: 2, funds: 1, fundMovements: 0, assets: 2, transactions: 3, planItems: 1, watchlist: 1, alerts: 2, loans: 0, loanPayments: 0, loanRiskAlerts: 0, total: 12 });
});
