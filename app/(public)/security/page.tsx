...
export default function SecurityPage() {
  return <div className="space-y-8">
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <Point icon={<RiKey2Line />} title="Secretهای سرور">کلید BrsApi و توکن Tindex فقط Server-side هستند و نباید با نام NEXT_PUBLIC یا داخل مخزن Commit شوند. TSETMC برای مسیر مستقیم بورس API Key ندارد.</Point>
