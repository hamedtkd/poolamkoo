...
export default function SecurityPage() {
  return <div className="space-y-8">
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <Point icon={<RiArchiveLine />} title="بکاپ رمزنگاری‌شده">بکاپ رمزدار از PBKDF2-SHA256 و AES-GCM استفاده می‌کند. رمز بکاپ توسط پولم‌کو ذخیره نمی‌شود؛ فراموش‌کردن آن یعنی فایل رمزدار قابل بازیابی نیست.</Point>
