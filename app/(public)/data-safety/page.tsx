...
export default function DataSafetyPage() {
  return <div className="space-y-8">
    ...
    <div className="grid gap-4 md:grid-cols-3">
      <Layer icon={<RiArchiveLine />} title="بکاپ مستقل">فایل JSON رمزنگاری‌شده با رمز انتخابی تو. برای نگهداری بلندمدت، این مهم‌ترین لایه است.</Layer>
