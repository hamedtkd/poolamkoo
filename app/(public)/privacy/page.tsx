...
export default function PrivacyPage() {
  return <article className="space-y-8">
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <Policy icon={<RiLineChartLine />} title="درخواست‌های بازار">برای قیمت بازار، سرور اپ ممکن است به TSETMC، BrsApi یا Tindex درخواست بزند. درخواست بورسی فقط شناسه عمومی نماد (InsCode) را حمل می‌کند؛ مبلغ درآمد، موجودی صندوق و تاریخچه تراکنش شخصی ارسال نمی‌شود.</Policy>
