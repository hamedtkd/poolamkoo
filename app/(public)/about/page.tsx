...
export default function AboutPage() {
  return <div className="space-y-8">
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Feature icon={<RiLineChartLine />} title="داده بازار">پولم‌کو برای داده بازار از TSETMC، BrsApi و Tindex استفاده می‌کند و در قطع موقت یک سرویس، تا جای ممکن داده را از منبع فعال دیگر می‌گیرد؛ داده ساختگی تاریخی تولید نمی‌شود.</Feature>
