...
const checks = [
  ...
  [packageSource.includes('"name": "poolamkoo"') && packageSource.includes('"version": "1.5.0"') && appVersionSource.includes('APP_VERSION = "1.5.0"'), "Package and runtime versions must use the canonical Poolamkoo v1.5.0 identity"],
