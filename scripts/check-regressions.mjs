...
const checks = [
  ...
  [packageSource.includes('"name": "poolamkoo"') && packageSource.includes('"version": "0.43.0"') && appVersionSource.includes('APP_VERSION = "0.43.0"'), "Package and runtime versions must use the canonical Poolamkoo v0.43.0 identity"],
