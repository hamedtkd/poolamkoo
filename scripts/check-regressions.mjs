...
const checks = [
  ...
  [packageSource.includes('"name": "poolamkoo"') && packageSource.includes('"version": "1.2.0"') && appVersionSource.includes('APP_VERSION = "1.2.0"'), "Package and runtime versions must use the canonical Poolamkoo v1.2.0 stable identity"],
