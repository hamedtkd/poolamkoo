...
const checks = [
  ...
  [packageSource.includes('"name": "poolamkoo"') && packageSource.includes('"version": "1.0.0-rc.1"') && appVersionSource.includes('APP_VERSION = "1.0.0-rc.1"'), "Package and runtime versions must use the canonical Poolamkoo v1.0.0-rc.1 identity"],
